...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _279: l => arrayFromDartList(Int8Array, l),
      _280: l => arrayFromDartList(Uint8Array, l),
      _281: l => arrayFromDartList(Uint8ClampedArray, l),
      _282: l => arrayFromDartList(Int16Array, l),
      _283: l => arrayFromDartList(Uint16Array, l),
      _284: l => arrayFromDartList(Int32Array, l),
      _285: l => arrayFromDartList(Uint32Array, l),
      _286: l => arrayFromDartList(Float32Array, l),
      _287: l => arrayFromDartList(Float64Array, l),
      _288: x0 => new ArrayBuffer(x0),
      _289: (data, length) => {
      ...
      _290: l => arrayFromDartList(Array, l),
      _291: () => ({}),
      _292: () => [],
      _293: l => new Array(l),
      _297: (o, p) => o[p],
      _298: (o, p, v) => o[p] = v,
      _299: (o, m, a) => o[m].apply(o, a),
      _301: o => String(o),
      _303: o => {
      ...
      _313: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _332: x0 => x0.random(),
      _333: x0 => x0.random(),
      _337: () => globalThis.Math,
      _339: Function.prototype.call.bind(Number.prototype.toString),
      _2722: x0 => x0.data,
      _2824: (x0,x1) => x0.onmessage = x1,
      _11973: (x0,x1) => globalThis.Object.getOwnPropertyDescriptor(x0,x1),
      _11974: (x0,x1) => globalThis.Reflect.get(x0,x1),
      _11975: f => finalizeWrapper(f, function() { return dartInstance.exports._11975(f,arguments.length) }),
